...
import {
    DropdownToggle, DropdownMenu, Card, CardHeader, CardBody,
                    ...
                    <div className="widget-content p-0">
                        <div className="widget-content-wrapper">
                                            ...
                                            {/* <CardHeader> */}
                                                <div className="widget-content">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            <div className="widget-heading">{this.user_data.data.email}</div>
                                                            <div className="widget-subheading text-capitalize">{this.user_data.data.role_name}</div>
                                                        </div>
                                                        <div className="widget-content-right me-2">
                                                            <Button onClick={this.logout} className="btn-pill btn-shadow btn-shine btn btn-focus" size="md">
                                                                Logout
                                                            </Button>
                                                        </div>
                                                    </div>
                            ...
                            <div className="widget-content-left  ms-3 header-user-info">
                                ...
                                {this.user_data.data.user_name}
                                </div>
                                <div className="widget-subheading text-capitalize">
                                {this.user_data.data.role_name}
                                </div>
                            </div>
